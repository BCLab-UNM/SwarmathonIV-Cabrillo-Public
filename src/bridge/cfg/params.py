...
gen.add("linear_Ki", double_t, 0, "Ki for linear velocity.", 0.01, 0, 1)
gen.add("linear_Kd", double_t, 0, "Kd for linear velocity.", 0.01, 0, 1)
...
gen.add("angular_Ki", double_t, 0, "Ki for angular velocity.", 0.01, 0, 1)
gen.add("angular_Kd", double_t, 0, "Kd for angular velocity.", 0.01, 0, 1)
